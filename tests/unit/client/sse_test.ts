...
import { SSEMCPClient } from "../../../src/client/sse.ts";
import type { SSEServerConfig } from "../../../src/types/config.ts";
import {
...
Deno.test({
  name: "SSEMCPClient - constructor sets config and timeout",
  ...
  fn() {
    ...
    const client = new SSEMCPClient("test-server", config);
...
Deno.test({
  name: "SSEMCPClient - connect creates transport and client",
  sanitizeResources: false,
  sanitizeOps: false,
  async fn() {
    setupMocks();
    ...
    (client as any).transport = new MockSSETransport(new URL(config.url));
...
Deno.test({
  name: "SSEMCPClient - connect handles already connected",
  sanitizeResources: false,
  sanitizeOps: false,
  async fn() {
    setupMocks();
...
Deno.test({
  name: "SSEMCPClient - disconnect closes client and transport",
  sanitizeResources: false,
  sanitizeOps: false,
  async fn() {
    setupMocks();
...
Deno.test({
  name: "SSEMCPClient - disconnect when not connected does nothing",
  sanitizeResources: false,
  sanitizeOps: false,
  async fn() {
    setupMocks();
...
Deno.test({
  name: "SSEMCPClient - getServerInfo returns server information",
  sanitizeResources: false,
  sanitizeOps: false,
  async fn() {
    setupMocks();
...
Deno.test({
  name: "SSEMCPClient - listTools returns tools",
  sanitizeResources: false,
  sanitizeOps: false,
  async fn() {
    setupMocks();
...
Deno.test({
  name: "SSEMCPClient - getTool returns specific tool",
  sanitizeResources: false,
  sanitizeOps: false,
  async fn() {
    setupMocks();
...
Deno.test({
  name: "SSEMCPClient - executeTool executes tool",
  sanitizeResources: false,
  sanitizeOps: false,
  async fn() {
    setupMocks();
...
Deno.test({
  name: "SSEMCPClient - listResources returns resources",
  sanitizeResources: false,
  sanitizeOps: false,
  async fn() {
    setupMocks();
...
Deno.test({
  name: "SSEMCPClient - readResource reads resource",
  sanitizeResources: false,
  sanitizeOps: false,
  async fn() {
    setupMocks();
...
Deno.test({
  name: "SSEMCPClient - listPrompts returns prompts",
  sanitizeResources: false,
  sanitizeOps: false,
  async fn() {
    setupMocks();
...
Deno.test({
  name: "SSEMCPClient - getPrompt gets prompt",
  sanitizeResources: false,
  sanitizeOps: false,
  async fn() {
    setupMocks();
...
Deno.test({
  name: "SSEMCPClient - operations throw when not connected",
  sanitizeResources: false,
  sanitizeOps: false,
  async fn() {
    setupMocks();
...
Deno.test({
  name: "SSEMCPClient - disconnect handles errors gracefully",
  sanitizeResources: false,
  sanitizeOps: false,
  async fn() {
    setupMocks();
